...
show_selection_menu() {
    ...
    selections=$(dialog --clear --backtitle "Zoolandia Workstation Setup" \
        ...
        --checklist "Use SPACE to select/deselect, ENTER to confirm:" 30 80 22 \
        ...
        "power" "Power Management Settings" $(is_installed "power") \
        "touchpad" "Touchpad Configuration" $(is_installed "touchpad") \
        "nautilus" "Nautilus File Manager Config" $(is_installed "nautilus") \
        2>&1 >/dev/tty)
